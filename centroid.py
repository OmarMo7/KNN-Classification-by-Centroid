...
def preprocessingImage(input_images):
    ...
    for image in input_images:
        ...
        # add circle at centroid point
        output_Image = cv2.circle(image, (cX, cY), 5, (255, 255, 255), -1)
        # add centroid to feature vector
        outputImages_list.append(output_Image)
...
def main():
    train_features, train_labels = readAndReshapeData(
        "train-images.idx3-ubyte", "train-labels.idx1-ubyte")
    test_features, test_labels = readAndReshapeData(
        "t10k-images.idx3-ubyte", "t10k-labels.idx1-ubyte")

    accuracy_score_for_openCv = openCv_model(
